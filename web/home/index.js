...
function (
    ...
    require(['bootstrap'],function(){});
            ...
            //引入猜你喜欢
var r = new Recommend('.guess-like', 6, false, true);
r.render();

function CarDiy() {
    var scaleRatio = 1;
    var IMAGES = [{'class': 'car-base', "url": '../home/img/base/base02.png'},
        //{'class': 'car-base', "url": '../rock/img/car-builder/cs15/roofColor/white/02.png'},
        //{'class': 'car-base', "url": '../rock/img/car-builder/cs15/louver/level2/02.png'},
        {'class': 'car-skin', "url": '../rock/img/car-builder/cs15/exteriorColor/orange/02.png'},
        {'class': 'car-skin', "url": '../rock/img/car-builder/cs15/exteriorColor/blue/02.png'},
        {'class': 'car-skin', "url": '../rock/img/car-builder/cs15/exteriorColor/red/02.png'},
        {'class': 'car-skin', "url": '../rock/img/car-builder/cs15/exteriorColor/gold/02.png'},
        {'class': 'car-skin', "url": '../rock/img/car-builder/cs15/exteriorColor/white/02.png'},
        {'class': 'car-skin', "url": '../rock/img/car-builder/cs15/exteriorColor/gray/02.png'},
        {'class': 'car-skin', "url": '../rock/img/car-builder/cs15/exteriorColor/black/02.png'}];
    ...
    var startX, offsetX, offsetY, moveX, currentX, tmpX, abs;
    // 是否为自动展示
    var isAutoShow = true;
    // 拖动状态
    var dragging = false;
    ...
    var changeColor = function (current) {
        ...
        $('#carBuilderWrap ' + currentColor).addClass("active").siblings().removeClass("active");
    };
    ...
    var touchMove = function (ev) {
        ...
        if (ev.originalEvent.targetTouches.length > 1 || ev.scale && ev.scale !== 1) return;
    ...
    var calcScroll = function (el) {
        var CB_HandleEl = $(el),
            ...
            CB_HandleOffsetTop = CB_HandleEl.offset().top,
    ...
    loading({
        images: IMAGES,
        el: '#onLoading',
        elWrap: '.car-builder-title, .car-builder-go, .car-builder-box'
    });
}
